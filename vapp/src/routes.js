...
import Regulator from "./components/pages/regulator/Regulator";
import CreateUser from "./components/pages/regulator/CreateUser";
import CheckViolators from "./components/pages/regulator/CheckViolators";
